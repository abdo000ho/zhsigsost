...
module.exports = {
    ...
    CHANNEL: 'https://t.me/+TT7JSOn-k8k4NGQ0',
    ...
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.ibb.co/h7MPTrS/image.jpg' : process.env.GAN_IMAGE,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'ABDO BOT V1' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://i.ibb.co/XZNNBKk/images.jpg' : process.env.ALL_IMG,
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://www.instagram.com/abdo_jfp/' : process.env.SOCIAL_MEDIA,
